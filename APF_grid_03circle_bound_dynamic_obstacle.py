...
T = 15  # finite time horizon length
dt = 0.1  # time step
WB = 2.5  # [m] Wheel base
...
if __name__ == '__main__':
    ...
    for radius in np.arange(30, 40.5+1.75, 1.75):
        waypoints.append(gen_round_points(senario_center, 30, radius))

    # ego_vehicle start position and end position
    ax = [0.0, -35.25]
    ay = [-35.25, 0.0]
    ...
    ego_vehicle.solver_basis(Q=np.diag([10, 10, 0, 3, 0]))
